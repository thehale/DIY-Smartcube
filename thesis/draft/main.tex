...
\degree{Bachelors of Software Engineering} % Your degree name, this is used in the title page and abstract, print it elsewhere with \degreename
...
\AtBeginDocument{
	...
	\hypersetup{citecolor=yellow} % Set the color of hyperlinks to ProblemSolved-You's Yellow
}
