...
\begin{enumerate}
    ...
    % TODO In the evaluation section, use accuracy as a metric to compare options to each other. Then in the conclusion's answer to this question, state the final, best accuracy that we could get. Be mindful then of the conditions in which this accuracy was attained, using a specific speaker, microphone, and background environment.
