...
variation between different speedcubes. % TODO Also consider weighing commercial smart cubes to show that (hopefully) mine is (considerably) lighter.
...
parameter \code{stdv\_pct} (Section \ref{subsec:fine-tuning-threshold})
varied through from 0.25 to 3 in increments of 0.25 for a total of 12
values. The minimum threshold parameter \code{min\_thresh} (Section
