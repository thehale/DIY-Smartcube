...
Each of these metrics will be discussed and analyzed in detail in the following sections.
...
TODO consider contrasting with commercial smartcubes that can provide
