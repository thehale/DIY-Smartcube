...
from FaceMapping import AbsolutePositioning
...
face_mapping = AbsolutePositioning()
for time_idx in range(len(time)):
    ...
    if len(important_freqs) > 0:
        detected_states = face_mapping.getState(important_freqs)
